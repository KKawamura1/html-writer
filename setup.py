...
user_name = 'KKawamura1'
module_name = 'html_writer'
...
#
path_to_version = path_to_here / module_name / '_version.py'
...
VERSION = _version.__version__  # type: str
...
#
short_description = 'A simple HTML writer'
...
# Content type for your long description
...
#
url = 'https://github.com/{}/{}'.format(user_name, module_name)
...
# Setup arguments with excluding None values
setup_keyword_arguments = dict(
    name=name,
    version=VERSION,
...
setup_keyword_arguments = {
    key: val
    for key, val in setup_keyword_arguments.items()
    if val is not None
}
setup(**setup_keyword_arguments)
